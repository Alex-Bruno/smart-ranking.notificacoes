...
export class AppService {
  ...
  async enviarEmailParaAdversario(desafio: Desafio) {
    ...
    try {
      ...
      const adversario: Jogador = await lastValueFrom(this.clientAdminBackend.send('consultar-jogadores', idAdversario)); 

      const solicitante: Jogador = await lastValueFrom(this.clientAdminBackend.send('consultar-jogadores', desafio.solicitante)); 
